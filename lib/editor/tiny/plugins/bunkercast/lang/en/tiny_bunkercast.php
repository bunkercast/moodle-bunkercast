...
/**
 * Language strings for tiny_bunkercast.
 *
...
$string['button_insert'] = 'Insert Bunkercast video';
$string['menuitem_insert'] = 'Bunkercast video';

$string['dialogtitle'] = 'Insert Bunkercast video';
$string['selectvideo'] = 'Video';
$string['selectvideo_help'] = 'Only encoded videos are listed. Upload and encode in Bunkercast first, then reopen this dialog.';
